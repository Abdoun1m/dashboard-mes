...
export const PipelinePage = () => {
  ...
  const hasError = pipeline.isError || freshness.isError;
    ...
    <div className="space-y-6">
      {hasError && (
        <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-3">
          ...
          <p className="text-xs text-amber-700 dark:text-amber-400">Certaines données du pipeline sont indisponibles - seules les informations accessibles sont affichées.</p>
        </div>
      )}
